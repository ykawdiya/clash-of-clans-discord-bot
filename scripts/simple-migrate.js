...
const mongoUri = process.env.MONGODB_URI || 'mongodb+srv://yashkawdiya2681:b2K97OOOmYvWd7of@doscordbot.iocwn.mongodb.net/test?retryWrites=true&w=majority';

// Note: Using hardcoded connection string just for immediate testing.
