...
module.exports = {
  ...
  async execute(interaction) {
    // Always defer the reply first to prevent timeouts
    ...
    try {
      ...
      // We already deferred, so we need to use editReply here
      await interaction.editReply({
  ...
  async handleInfo(interaction) {
    try {
      ...
      throw error; // Let the main execute method handle it
    }
  },
